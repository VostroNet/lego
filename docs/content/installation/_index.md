...
To get the binary just download the latest release for your OS/Arch from [the release page](https://github.com/vostronet/lego/releases) and put the binary somewhere convenient.
...
```bash
go get -u github.com/vostronet/lego/cmd/lego
```
